  // OM: "_searchStruct".oBtnQuery (new LV 23.07.20, 16:29:20)
  // Last change: LV 23.07.20, 16:29:20
...
Case of 
	: (Form event code:C388=On Clicked:K2:4)
		Case of 
			: (Form:C1466.searchResults=Null:C1517)
				BEEP:C151
			: (Form:C1466.searchResults.length<1)
				BEEP:C151
			Else 
				...
				If (($useRegexFilter) & (Length:C16($filterItemName)>0))
					...
					Form:C1466.searchResultsDisplay:=Form:C1466.searchResults.filter("zMatchRegexColFunc";$filterItemName;$filterString)
				...
				Else 
					Case of 
						...
						: (Length:C16(Form:C1466.txtQuery)<2)
							BEEP:C151
						Else 
							Form:C1466.searchResultsDisplay:=Form:C1466.searchResults.query(Form:C1466.txtQuery)
					End case 
				End if 
		End case 
